...
const SIDEBAR: Record<string, SidebarEntry[]> = {
  "🎮 Online Games": [
    { name: "Boohbah Zone (Flash Archive)", url: "httpimport { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
...
export default function GameRoom() {
  ...
  const navigate = (url: string, title: string, embed = false) => {
    // Automated check: if it's a wayback machine link missing the direct embedding suffix, patch it
    let cleanUrl = url;
                ...
                <div className="bg-white border border-[#7f9db9] rounded shadow-sm p-4 mb-4">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      { name: "Moshi Monsters", url: "https://web.archive.org/web/20130126022802if_/https://www.moshimonsters.com/", icon: "👾" },
...
}s://archive.org/details/boobah_zone_flash" },
