...
export default function GameRoom() {
  ...
  return (
    <div
      className="w-full h-full flex flex-col bg-[#ece9d8] select-none overflow-hidden"
    ...
    >
      ...
      {/* ── STATUS BAR ── */}
      <div className="flex items-center px-2 shrink-0" style={{ background: "#ece9d8", borderTop: "1px solid #aca899", height: 20 }}>
      ...
      {/* ── XP TASKBAR ── */}
      <div className="h-10 shrink-0 flex items-center px-1 gap-1" style={{ background: "linear-gradient(180deg,#245edb 0%,#3f8cf3 40%,#245edb 100%)", borderTop: "1px solid #1a4bb8" }}>
        <button
        ...
        <AnimatePresence>
          {startMenuOpen && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: 10 }}
              className="absolute bottom-10 left-0 w-72 bg-[#ece9d8] rounded-t-lg shadow-[0_-5px_20px_rgba(0,0,0,0.3)] border border-[#0055e5] overflow-hidden z-50"
              onClick={e => e.stopPropagation()}
            >
