...
export default function MyRoom() {
  ...
  return (
    <div className="relative w-full h-full bg-[#1a1a1a] flex items-center justify-center font-sans text-white p-4">
      {/* Centered Image Container to ensure image fits */}
      <div className="relative w-[1000px] h-[800px] border-4 border-white/20 shadow-2xl overflow-hidden bg-[#1a1a1a]">
        <div 
        ...
        {/* Adjusted Computer Clickable Area - repositioned to fit computer */}
        <div 
        ...
        {/* Adjusted Nightstand Clickable Area - repositioned to fit nightstand */}
        <div 
...
export default function MyRoom() {
  ...
  return (
    <div className="relative w-full h-full bg-[#1a1a1a] flex items-center justify-center font-sans text-white p-4">
      ...
      <div className="relative w-[1000px] h-[800px] border-4 border-white/20 shadow-2xl overflow-hidden">
        <div 
